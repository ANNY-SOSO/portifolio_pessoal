...
function animateText () {
    if (isTyping) {
        ...
        if (index > 1) {
            ...
            isTyping = true;
            // Alterna a cor do texto entre branco/preto e azul
            currentColor = currentColor === (document.documentElement.classList.contains('light') ? 'black' : '#fff') ? '#312cb3' : (document.documentElement.classList.contains('light') ? 'black' : '#fff');
